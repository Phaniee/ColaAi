...
--
-- Host: 127.0.0.1
-- Tempo de geração: 29/04/2024 às 16:43
...
(8, 'Pinacoteca - acervo ', '08160-370', 'Rua Rio do Ouro', '4', '', 'Parque Industrial', 'São Paulo', 'SP', '2024-04-26', '4', '1', '1', '2', 'museu', 1, 'ca41e3faf3d2ade6c1fbae91d9c5f4c9.jpg');
...
--
-- Despejando dados para a tabela `tbfeedbackapp`
--

INSERT INTO `tbfeedbackapp` (`idFeedBackApp`, `tituloFeedBackApp`, `descFeedbackApp`, `idUsuario`) VALUES
(1, 'AMEI O SITE', 'amei o site', 10);
...
INSERT INTO `tbpublicacao` (`idPublicacao`, `tituloPublicacao`, `descPublicacao`, `linkOrganizacaoEvento`, `imagemPublicacao`, `idOrganizacaoEvento`) VALUES
(3, 'pina', 'evento legal.', NULL, '', 1);
...
(7, 'stephanie', 'Silva ', 'ste@teste.com', '1234', '(11)95283-0532', NULL, NULL),
(8, 'Richard', 'lindo', 'riri@teste.com', 'senha123', '(11)99999-9999', NULL, NULL),
(9, 'Bruna', 'Silva ', 'bruna@teste.com', '1234', '(11)99999-9999', NULL, NULL),
(10, 'stephanie', 'Silva ', 'admin@teste.com', 'senha123', '(11)99999-9999', NULL, NULL),
(11, 'thierry', 'Silva ', 'thi@teste.com', '1234', '(11)88888-8888', NULL, NULL);
...
ALTER TABLE `tbpublicacao`
  ...
  ADD KEY `fk_idOrganizacaoEvento` (`idOrganizacaoEvento`);
...
--
ALTER TABLE `tbfeedbackapp`
  MODIFY `idFeedBackApp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tbpublicacao`
  ADD CONSTRAINT `fk_idOrganizacaoEvento` FOREIGN KEY (`idOrganizacaoEvento`) REFERENCES `tborganizacaoevento` (`idOrganizacaoEvento`);
